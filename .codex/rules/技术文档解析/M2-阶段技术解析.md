...
- `.codex/rules/架构.md`：项目总 Spec，项目业务、技术路线、目标架构与全局验收的唯一设计依据；
- `.codex/rules/roadmap/M2-意图约束澄清与路由.md`：M2 实施规格；
- `evaluation/reports/M2-completion.md`：M2 验收报告；
- `evaluation/reports/M2-handoff.md`：M2 交接报告；
- `.codex/rules/adr/ADR-002-m2-hybrid-routing-and-constraint-priority.md`：M2 混合路由与约束优先级决策。
