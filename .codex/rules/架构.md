...
- 阶段人工验收接口：`.codex/rules/roadmap/amendments/ACC-INFRA-1-阶段人工验收接口规格.md`；
- 项目执行规则：`AGENTS.md`；
