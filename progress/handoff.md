...
#### R1: PromptBuilder + 模板 (原 R1+R2 合并)
...
#### R3: Planning Agent — Chain-of-Thought 改造 (原 R3)
...
#### P1: MessageValidator + 版本化 (原 P1+P2 合并)
...
#### P2: StateMachine 完善 — 可视化 + 测试辅助 (原 P3)
