...
> 
> **进度**: 已完成 9/10 Step (Step 0 + R1 + R2 + R3 + R4 + P1 + P2 + P3 + 测试优化)。剩余: I1 (集成测试) → I2 (E2E 回归)。
...
> 
> **本文件 §12 v2 为 10 Step (Step 0 + R1-R4 + P1-P3 + I1-I2)**。当前 R4 已完成 (98e27e6)，P3/I1/I2 仍待开发；I2 完成后才达到 v1.2.0。
> 
